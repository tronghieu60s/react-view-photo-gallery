...
export function IconsArrowNext() {
  return (
    <svg viewBox="0 0 24 24">
...
export function IconsLinkExternal() {
  return (
    <svg viewBox="0 0 24 24">
...
export function IconsFullscreen() {
  return (
    <svg viewBox="0 0 24 24">
...
export function IconsPlayCircle() {
  return (
    <svg viewBox="0 0 24 24">
